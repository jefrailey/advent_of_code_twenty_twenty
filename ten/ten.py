...
def part_one(adapters: Sequence[int]) -> int:
    ...
    Assume all adapters can be used in sequence. Meaninging, the largest difference between
    consecutive adapters is 3.
    """
    adapters = sorted(adapters)

    counts = {
        1: 1,  # The diff between the outlet and the first charger
        2: 0,
        3: 1,  # The diff between the last adapter and the device is always 3
    }
    previous = adapters[0]
